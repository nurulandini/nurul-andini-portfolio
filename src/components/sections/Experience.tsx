...
export default function Experience() {
  ...
  return (
    <section id="experience" className="relative overflow-hidden px-6 py-30">
      <div className="mx-auto max-w-7xl">
        ...
        <motion.div
          ...
          className="max-w-4xl"
        >
          <h2 className=" -mt-6 text-5xl font-bold leading-[0.95] tracking-tighter md:text-7xl xl:text-[88px]">
        ...
        <div className="relative mt-28">
          {/* LINE */}
          <div className="absolute left-7 top-0 hidden h-full w-px bg-linear-to-b from-sky-500/40 via-white/10 to-transparent md:block" />
                ...
                <div className="grid gap-8 md:grid-cols-[70px_1fr]">
                  ...
                  <div className="relative hidden md:flex justify-center">
                    <div className="relative z-10 mt-2 flex h-14 w-14 items-center justify-center rounded-full border border-sky-400/20 bg-[#07111f] backdrop-blur-xl">
                      <div className="h-3 w-3 rounded-full bg-linear-to-r from-sky-400 to-cyan-300" />
                    </div>
                  </div>
